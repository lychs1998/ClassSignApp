...
import red.clf.app.afinal.activity.MainActivity;
import red.clf.app.afinal.schedule.ColorUtils;
import red.clf.app.afinal.schedule.CornerTextView;
import red.clf.app.afinal.schedule.CourseDao;
import red.clf.app.afinal.schedule.CourseModel;
...
public class AllSchedule  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        View view = inflater.inflate(R.layout.fragment_all_schedule, container, false);
    ...
    private void initWeekCourseView() {
        ...
        for (int i = 0; i < mWeekViews.size(); i++) {
            initWeekPanel(mWeekViews.get(i), courseDao.initDB()[i]);
        }
    }
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("teacher",courseModel.getTeacher());
                    intent.putExtra("course",courseModel.getCourseName());
                    intent.putExtra("detailid",courseModel.getDetailid());
